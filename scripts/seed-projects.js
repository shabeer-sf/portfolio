...
async function main() {
  ...
  const projects = [
    ...
    // },
    {
  title: "NeuralFlow AI - SaaS Analytics Platform",
  slug: "neuralflow-ai",
  shortDescription: "A modern, responsive landing page for an AI-powered analytics SaaS platform.",
  longDescription:
    "NeuralFlow AI is a comprehensive AI analytics platform landing page built with Next.js, React, and Framer Motion. It highlights AI-powered insights, predictive modeling, enterprise-grade security, and multiple pricing tiers.",
  content: "A sleek SaaS landing page demonstrating NeuralFlow AI’s capabilities including dashboards, pricing, and integrations.",
  problem: "Needed a professional SaaS landing page to showcase AI-powered analytics and attract enterprise clients.",
  solution: "Developed a responsive landing page with smooth animations, modern UI/UX, and detailed business feature highlights.",
  results: "Improved brand credibility and provided a scalable foundation for showcasing SaaS offerings.",
  link: "https://neural-flow-alpha.vercel.app/",
  image: "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg", // replace with actual screenshot if you have
  images: [
    "https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg"
  ],
  githubUrl: "https://github.com/shabeer-sf/NeuralFlow.git",
  showGithub: false,
  liveUrl: "https://neural-flow-alpha.vercel.app/",
  demoUrl: null,
  technologies: ["Next.js", "React", "Framer Motion", "TailwindCSS", "TypeScript"],
  features: [
    "Responsive design",
  ...
  challenges: [
    "Designing smooth animations for multiple sections",
    "Balancing modern visuals with fast performance",
    "Structuring scalable component architecture"
  ],
  learnings: [
    "Advanced usage of Framer Motion for SaaS landing pages",
    "Optimizing Next.js App Router for large landing pages",
    "Improving performance with Tailwind and Next.js Image component"
  ],
  categorySlug: "web",
  status: "COMPLETED",
  featured: true,
